package net.seanomik.tamablefoxes.versions.version_1_21_9_R1.pathfinding;

import java.util.EnumSet;
import net.minecraft.world.entity.LivingEntity;
import net.minecraft.world.entity.ai.goal.target.TargetGoal;
import net.minecraft.world.entity.ai.targeting.TargetingConditions;
import net.seanomik.tamablefoxes.versions.version_1_21_9_R1.NMSUtil;
import org.bukkit.event.entity.EntityTargetEvent.TargetReason;
import net.seanomik.tamablefoxes.versions.version_1_21_9_R1.EntityTamableFox;
